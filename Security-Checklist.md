...
The audit conducted shows that the security level of Botium Toys is very low, which could lead to data breaches and loss of customer’s trust. These issues can be prevented by giving access to only a few people, proper storage of data, update of password rules and policies, back up data and set up plans to recover from issues. Data encryption should be put in place.

If these solutions are put in place, Botium Toys security will be improved and customer data will be more protected, reducing the risk of cyber threat and building trust in clients.